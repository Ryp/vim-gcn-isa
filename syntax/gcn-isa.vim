...
syn match gcn3ScalarALU  "\vs_(cmp|cmpk)_(eq|ne|gt|ge|le|lt)_((u|i)(16|32))"
...
syn match gcn3ScalarALU "\vs_set_gpr_idx_(off|on|idx|mode)"
...
syn keyword gcn3VectorALU v_mul_lo_u32
syn keyword gcn3VectorALU v_mul_hi_i32 v_mul_hi_u32
syn keyword gcn3VectorALU v_lshlrev_b64 v_lshrrev_b64 v_ashrrev_i64
...
syn keyword gcn3VectorALU v_ashrrev_i16 v_ashrrev_b32
...
syn keyword gcn3VectorALU v_frexp_mant_f16 v_frexp_mant_f32 v_frexp_mant_64
syn keyword gcn3VectorALU v_frexp_exp_i32_f32 v_frexp_exp_i16_f16
syn keyword gcn3VectorALU v_clrexcp

""" Compare Operations
syn match gcn3VectorALU "\vv_(cmp|cmpx)_(f|lt|eq|le|gt|lg|ge|t)_((u|i)(16|32|64))"
syn match gcn3VectorALU "\vv_(cmp|cmpx)_(f|lt|eq|le|gt|lg|ge|t|o|u|nge|nlg|ngt|nle|neq|nlt)_(f(16|32|64))"
syn match gcn3VectorALU "\vv_(cmp|cmpx)_class_(f(16|32|64))"

" Scalar Memory Operations
syn match gcn3SMEM "\vs_load_dword(x(2|4|8|16))?"
syn match gcn3SMEM "\vs_store_dword(x(2|4))?"
syn match gcn3SMEM "\vs_buffer_load_dword(x(2|4|8|16))?"
syn match gcn3SMEM "\vs_buffer_store_dword(x(2|4))?"
...
syn match gcn3DataShareOp "\vds_write_src2_b(32|64)"
syn match gcn3DataShareOp "\vds_(add|sub|rsub|inc|dec)(_rtn)?_u(32|64)"
syn match gcn3DataShareOp "\vds_(add|sub|rsub|inc|dec)_src2_u(32|64)"
syn match gcn3DataShareOp "\vds_(min|max)(_rtn)?_[iuf](32|64)"
syn match gcn3DataShareOp "\vds_(min|max)_src2_[iuf](32|64)"
syn match gcn3DataShareOp "\vds_(and|or|xor|mskor)(_rtn)?_b(32|64)"
syn match gcn3DataShareOp "\vds_(and|or|xor)_src2_b(32|64)"
syn match gcn3DataShareOp "\vds_cmpst(_rtn)?_[bf](32|64)"
...
syn keyword gcn3DataShareOp ds_condxchg32_rtn_b64
syn keyword gcn3DataShareOp ds_condxchg32_rtn_b128
